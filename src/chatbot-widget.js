(function() {
    ...
    // Configuration
    const CONFIG = {
        apiEndpoint: 'https://mydomain.com/chat',
    ...
    class ChatbotWidget {
        ...
        createWidget() {
            ...
            this.widget.innerHTML = `
                <div class="chatbot-window">
                    ...
                    <div class="chatbot-input-area">
                        ...
                        <button class="chatbot-send-button">➤</button>
                    </div>
                </div>
            ...
            this.button = this.widget.querySelector('.chatbot-button');
            ...
            this.sendButton = this.widget.querySelector('.chatbot-send-button');
        ...
        addMessage(sender, text) {
            ...
            while (this.messages.children.length > CONFIG.maxMessages) {
    ...
    function initWidget() {
        ...
        // Auto-initialize if no custom elements found
